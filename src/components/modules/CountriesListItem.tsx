...
const CountriesListItem = ({
  ...
  return (
    <Link
      href={`/country/` + createSlug(name)}
      className="w-full mx-10 md:mx-0 md:w-[300px]"
    >
      <div className="flex flex-col my-3 bg-white dark:bg-gray-700  text-black dark:text-white shadow-md rounded-md w-full md:w-[300px]">
        <Image
          src={flags ? flags : "/img/img-placeholder.jpg"}
          alt={name}
          width={200}
          height={120}
          priority={true}
        ...
        <div className="ml-3 m-2">
          <p className="font-extrabold my-3 text-[2.5vw] md:text-[1vw]">
            {name}
          </p>
